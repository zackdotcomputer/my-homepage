...
export default function ExperienceSection() {
  return (
    <div>
      ...
      <p>
        I&rsquo;m a full-time freelance senior engineer, helping teams realize their potential and
        complete their projects. If you have need for someone with my experience,{" "}
        <Link to="/contact">send me an email</Link>.
      </p>
      <p>
        Additionally, I&rsquo;m working on building tools and code to improve the open-source
        community and the closed-source developer experience.
      </p>
